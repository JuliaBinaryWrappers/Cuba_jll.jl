...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Cuba_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3bed1096-5ab2-53a1-92e2-6c1cc31d0f4b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Cuba", artifacts_toml) for e in artifacts["Cuba"]]
...
if best_platform === nothing
    @debug("Unable to load Cuba; unsupported platform $(triplet(platform_key_abi()))")
else
